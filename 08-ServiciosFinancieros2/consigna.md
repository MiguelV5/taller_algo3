...
El resumen de cuentas (Account Summary).
El neto de transferencias (Transfer Net).
...
Poder agregar futuros reportes sin tener que modificar la jerarquía de cuentas.
Poder agregar futuros reportes sin tener que modificar la jerarquía de transacciones.
Crear nuevos reportes debe implicar crear clases nuevas únicamente y no modificar ninguna existente.
